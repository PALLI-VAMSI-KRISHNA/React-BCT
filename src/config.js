...
export const CONTACT_ABI = [
	...
	},
	{
		...
		"outputs": [
			...
			{
				"internalType": "enum BloodProduction.BloodPacketStatus",
				"name": "status",
				"type": "uint8"
			}
		],
		...
		"outputs": [
			{
				...
				"internalType": "struct BloodProduction.BloodPacket",
				"name": "",
				"type": "tuple"
			}
		],
